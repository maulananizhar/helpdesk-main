          ...
          <div className="lg:w-1/2 w-full flex flex-col lg:items-start items-center justify-center">
            ...
            <form
              ...
              <button
                type="submit"
                disabled={!captcha}
                className="uppercase font-medium text-lg w-full bg-primary text-white rounded-lg py-4 mt-2 hover:cursor-pointer disabled:bg-gray-400 transition-colors duration-300">
                Masuk
              </button>
            </form>
