...
// import function getUlasanPIC
import getUlasanPIC from "../../libs/getUlasanPIC";
    ...
    <>
      <div
        ...
        <div className="w-full">
          <p className="text-xl font-medium mb-4">Ulasan terhadap PIC</p>
          <div
              ...
              currentItems.map((item, index) => {
                return (
                  <UlasanCard
                    ...
                    testimonial={item.testimonialpic}
                  />
                );
              })
            ) : (
